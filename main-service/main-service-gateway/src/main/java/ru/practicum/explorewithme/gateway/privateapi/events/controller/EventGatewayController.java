...
public class EventGatewayController {
    ...
    public ResponseEntity<Object> getRequestsByOwnerEventAndEventId(@PathVariable @Positive(message = VALIDATION_USER_ID) Long userId,
                                                                    @PathVariable @Positive(message = VALIDATION_EVENT_ID) Long eventId) {
        return eventClient.getRequestsByOwnerEventAndEventId(userId, eventId);
    }

    @PatchMapping("/{userId}/events/{eventId}/requests")
    public ResponseEntity<Object> approveRequestByOwnerId(@PathVariable @Positive(message = VALIDATION_USER_ID) Long userId,
                                                          @PathVariable @Positive(message = VALIDATION_EVENT_ID) Long eventId,
